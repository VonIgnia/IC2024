...
# Assign random values between -1 and 1 to each electrode
electrode_values = np.random.uniform(-1, 1, len(electrodes))
...
# Display the brain mesh with electrodes and colormap
vedo.show(brain_mesh, *electrode_points, *electrode_labels, axes=1, title="EEG Electrode Positions with Value Gradient")
